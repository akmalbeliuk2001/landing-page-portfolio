    ...
    <div class="relative mx-auto px-4 md:px-7 lg:px-0 lg:max-w-[1064px] h-full">
      <div class="absolute left-[50%] translate-x-[-50%] top-[50%] translate-y-[-50%] w-full">
        <div class="relative w-max mx-auto">
          <img class="w-[283.86px] h-[94.23px] rotate-[-2deg]" src="@/assets/ellipse_ornament.png" alt="">
          <p class="poppins font-semibold text-[61.04px] tracking-tighter absolute top-[0px] left-[-25px]">EDUCATION</p>
        </div>
